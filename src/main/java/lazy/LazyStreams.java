...
public class LazyStreams
{
	...
	{
		System.out.printf(
				"Inside multByTwo with arg %d on thread %s%n",
				n,
	...
	{
		System.out.printf(
				"Inside modByThree with arg %d on thread %s%n",
				n,
				Thread.currentThread()
						.getName()
						 );
	...
	public static void main(String[] args)
	{
		...
		int firstEvenDoubleDivBy3 = IntStream.rangeClosed(
						100,
						200
														 )
				.map(n -> n * 2)
		...
		firstEvenDoubleDivBy3 = IntStream.rangeClosed(
						100,
						2_000_000
													 )
				// .parallel()
				...
				.orElse(0);
		System.out.printf(
				"First even divisible by 3 is %d%n",
