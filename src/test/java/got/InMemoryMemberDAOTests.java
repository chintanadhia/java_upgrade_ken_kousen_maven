...
public class InMemoryMemberDAOTests
{
	...
	public void startWithS_sortAlphabetically()
	{
		...
		assertAll(
				() -> assertThat(members.get(0)
						.name()).isEqualTo("Sansa"),
				() -> assertThat(members.get(1)
						.name()).isEqualTo("Stannis")
				 );
	}
	...
	public void averageSalary()
	{
		...
		assertThat(averageSalary).isCloseTo(
				100611.64,
				within(0.1)
										   );
	}
	...
	public void houseStats()
	{
		...
		assertAll(
				() -> assertThat(stats.get(House.STARK)
						.getMax()).isEqualTo(100000.0),
				() -> assertThat(stats.get(House.STARK)
						.getMin()).isEqualTo(10000.0),
				() -> assertThat(stats.get(House.STARK)
						.getAverage())
						.isCloseTo(
								66666.66,
